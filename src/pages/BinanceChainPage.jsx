...
const BinanceChainPage = () => (
  ...
  <a href="https://accounts.binance.com/en/login" className="bg-[#23262F] text-white px-4 py-2 rounded font-semibold text-sm hover:bg-gray-700">Log In</a>
  <a href="https://accounts.binance.com/en/register" className="bg-[#F3BA2F] text-black font-bold px-4 py-2 rounded text-sm hover:bg-yellow-400 transition">Sign Up</a>
