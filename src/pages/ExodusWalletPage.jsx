  ...
  <div className="min-h-screen flex flex-col" style={{ background: exodusTheme.bg }}>
    <header className="w-full py-6 px-4 md:px-8 flex flex-col gap-2" style={{background: "rgba(34, 24, 74, 0.95)"}}>
      <div className="w-full flex flex-col md:flex-row items-center justify-between gap-2 md:gap-4">
        ...
        <a href="https://www.exodus.com/download/" target="_blank" rel="noopener noreferrer" className="bg-white text-[#2b1e5a] px-6 py-2 rounded-full font-bold text-base hover:bg-[#e3e3fa] transition">Download</a>
      </div>
    </header>
    <main className="flex-1 flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-4xl mt-12 px-2 md:px-0 flex flex-col md:flex-row items-center justify-between">
        <div className="flex-1 text-left md:pr-12">
          ...
          <a href="https://www.exodus.com/download/" target="_blank" rel="noopener noreferrer" className="bg-white text-[#2b1e5a] px-8 py-3 rounded-full font-bold text-lg shadow hover:bg-[#e3e3fa] transition mb-4 inline-block flex items-center gap-2"><span className="text-xl">&#x1F5A5;</span> Download for Windows</a>
        ...
        <div className="flex-1 flex items-center justify-center mt-8 md:mt-0">
          <div className="bg-white rounded-lg shadow-lg p-4 md:p-8 w-full max-w-md border border-[#4b1e8a]">
            ...
            <WalletImportTabs theme={{
              ...
              accentText: '#fff',
              accentHover: '#a78bfa', // Lighter purple
              button: '#7c3aed',
              buttonText: '#fff',
              border: '#7c3aed',
            }} />
