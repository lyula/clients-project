...
const BnbPage = () => {
  ...
  const bnbWallet = wallets.find((wallet) => wallet.name === "BNB");
      ...
      <header className="w-full py-4 px-4 md:px-8 flex flex-col gap-2 bg-[#181a20] border-b border-[#f3ba2f]">
        <div className="w-full flex items-center justify-between">
          <div className="flex items-center gap-4">
            <img src={bnbWallet.image} alt="BNB Chain Logo" className="w-10 h-10 rounded-full" />
          ...
          <div className="md:hidden flex items-center">
            ...
            >
              <svg width="32" height="32" fill="none" viewBox="0 0 24 24">
                <rect y="6" width="24" height="2" rx="1" fill="#f3ba2f" />
                <rect y="11" width="24" height="2" rx="1" fill="#f3ba2f" />
                <rect y="16" width="24" height="2" rx="1" fill="#f3ba2f" />
              </svg>
            </button>
          </div>
          <div className="hidden md:flex flex-wrap justify-center items-center gap-4 flex-1">
            <a
              ...
              className="text-[#fff] font-bold text-center text-[15px] px-2"
            >
              Chain
            </a>
            <a href="https://www.bnbchain.org/en/wallets" className="text-[#fff] font-bold text-center text-[15px] px-2">
              Build
            </a>
            <a href="https://www.bnbchain.org/en/blog" className="text-[#fff] font-bold text-center text-[15px] px-2">
              Explore
            </a>
            <a
            ...
            <a
              href="https://www.bnbchain.org/en/community"
              className="text-[#fff] font-bold text-center text-[15px] px-2"
            >
              Connect
            </a>
          ...
          <a
            href="https://www.bnbchain.org/en/cookbook"
            className="hidden md:inline-block bg-[#f3ba2f] text-[#222] px-6 py-2 rounded-full font-bold text-base hover:bg-[#ffe066] transition ml-2"
          >
            Get Started
          </a>
        </div>
        ...
        {menuOpen && (
          <>
            ...
            <div className="fixed top-0 right-0 z-50 w-3/4 max-w-xs h-full bg-[#181a20] shadow-2xl rounded-l-xl flex flex-col gap-2 p-6 text-right animate-slide-in">
              ...
              <a href="https://www.bnbchain.org/en/bnb-smart-chain" className="text-[#fff] font-bold text-[16px] py-2">
                Chain
              </a>
              <a href="https://www.bnbchain.org/en/wallets" className="text-[#fff] font-bold text-[16px] py-2">
                Build
              </a>
              <a href="https://www.bnbchain.org/en/blog" className="text-[#fff] font-bold text-[16px] py-2">
                Explore
              </a>
              <a href="https://www.bnbchain.org/en/hackathons" className="text-[#fff] font-bold text-[16px] py-2">
                Accelerate
              </a>
              <a href="https://www.bnbchain.org/en/community" className="text-[#fff] font-bold text-[16px] py-2">
                Connect
              </a>
            </div>
          </>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4">
        ...
        <div className="w-full md:hidden mt-6 px-2">
          ...
          <p className="text-base text-[#888] mb-6">
            Wallets help you access your funds, and interact with decentralized applications on BNB Chain.
          </p>
          <a
            href="https://bnbchain.org/en/wallets"
            className="bg-[#f3ba2f] text-[#222] px-8 py-3 rounded-full font-bold text-lg shadow hover:bg-[#ffe066] transition mb-4 inline-block"
          >
            BNB Chain Wallets
          </a>
        </div>
