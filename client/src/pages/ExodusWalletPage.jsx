...
const ExodusWalletPage = () => {
  const exodusWallet = wallets.find((wallet) => wallet.name === "Exodus Wallet");
      ...
      <header className="w-full py-6 px-4 md:px-8 flex flex-col gap-2" style={{ background: "rgba(34, 24, 74, 0.95)" }}>
        <div className="w-full flex flex-col md:flex-row items-center justify-between gap-2 md:gap-4">
          <div className="flex items-center gap-4">
            <img src={exodusWallet.image} alt="Exodus Wallet Logo" className="w-10 h-10 rounded-full" />
          ...
          <div className="flex flex-wrap justify-center items-center gap-2 md:gap-4 flex-1">
            <a href="#" className="text-[#fff] font-bold text-center text-[15px] px-2">
              Products
            </a>
            <a href="#" className="text-[#fff] font-bold text-center text-[15px] px-2">
              Support
          ...
          <a href="https://www.exodus.com/download/" className="bg-white text-[#2b1e5a] px-6 py-2 rounded-full font-bold text-base hover:bg-[#e3e3fa] transition">
            Download
          </a>
        </div>
      </header>
      <main className="flex-1 flex flex-col items-center justify-center px-4">
        ...
        <div className="w-full md:hidden mt-6 px-2 text-left">
          <div className="flex items-center gap-2 mb-4">
            <span className="bg-[#3b2e6a] text-[#fff] px-4 py-2 rounded-full text-sm font-semibold flex items-center gap-2">
              <span className="text-lg">🔒</span> Trusted by millions of customers since 2015
            </span>
          </div>
          ...
          <a
            ...
            className="bg-white text-[#2b1e5a] px-8 py-3 rounded-full font-bold text-lg shadow hover:bg-[#e3e3fa] transition mb-4 inline-block flex items-center gap-2"
          >
            <span className="text-xl">🖥️</span> Download for Windows
          </a>
