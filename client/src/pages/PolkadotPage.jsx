  ...
  <div className="min-h-screen flex flex-col" style={{ background: polkadotTheme.bg }}>
    <header className="w-full py-6 px-4 md:px-8 flex flex-col gap-2" style={{background: "#e3e6ff"}}>
      <div className="w-full flex justify-center">
        <nav className="flex items-center gap-2 md:gap-6 px-4 py-2 rounded-full" style={{background: "linear-gradient(90deg, #a1a7e6 0%, #6b7fdc 100%)", boxShadow: "0 2px 12px rgba(0,0,0,0.08)", borderRadius: "2rem"}}>
          ...
          <a href="https://polkadot.com/get-started/wallets/" className="text-white font-bold text-base px-2 hover:underline">Get started</a>
          <a href="https://polkadot.com/platform/" className="text-white font-bold text-base px-2 hover:underline">Platform</a>
    ...
    <main className="flex-1 flex flex-col items-center justify-center px-4">
      ...
      <div className="w-full md:hidden mt-6 px-2 text-left">
        ...
        <h1 className="text-2xl font-bold text-[#222] mb-4">Your passport to Polkadot</h1>
        <p className="text-base text-[#444] mb-6">Start exploring Polkadot with a secure and user-friendly wallet. Ready to turbocharge your Web3 journey?</p>
