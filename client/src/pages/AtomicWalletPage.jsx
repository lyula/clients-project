...
const AtomicWalletPage = () => {
  const atomicWallet = wallets.find((wallet) => wallet.name === "Atomic Wallet");
    ...
    <div className="min-h-screen flex flex-col" style={{ background: atomicTheme.bg }}>
      <header className="w-full py-6 px-4 md:px-8 flex flex-col gap-2 bg-[#1a2a3a] border-b border-[#1976d2]">
        <div className="w-full flex flex-col md:flex-row items-center justify-between gap-2 md:gap-4">
          <div className="flex items-center gap-4">
            <img src={atomicWallet.image} alt="Atomic Wallet Logo" className="w-10 h-10 rounded-full" />
          ...
          <div className="flex flex-wrap justify-center items-center gap-2 md:gap-4 flex-1">
            <a href="https://atomicwallet.io/prices" className="text-[#fff] font-bold text-center text-[15px] px-2">
              Assets
            </a>
            <a href="https://atomicwallet.io/btc-to-eth-exchange" className="text-[#fff] font-bold text-center text-[15px] px-2">
              Exchange
            </a>
            <a href="https://atomicwallet.io/buy-crypto" className="text-[#fff] font-bold text-center text-[15px] px-2">
              Buy Crypto
            </a>
            <a href="https://atomicwallet.io/staking" className="text-[#fff] font-bold text-center text-[15px] px-2">
              Stake & Earn
            </a>
            <a href="https://atomicwallet.io/downloads" className="text-[#fff] font-bold text-center text-[15px] px-2">
              Products
            </a>
          </div>
          <a href="https://atomicwallet.io/downloads" className="bg-[#2196f3] text-white px-6 py-2 rounded-full font-bold text-base hover:bg-[#1976d2] transition">
            Download
          </a>
        </div>
      </header>
      <main className="flex-1 flex flex-col items-center justify-center px-4">
        ...
        <div className="w-full md:hidden mt-6 px-2 text-left">
          ...
          <a href="https://atomicwallet.io/downloads" className="bg-white text-[#1976d2] px-8 py-3 rounded-full font-bold text-lg shadow hover:bg-[#e3f2fd] transition mb-4 inline-block">
            DOWNLOAD
          </a>
